...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 22, fontWeight: 'bold', color: '#B7E4C7', textAlign: 'center', marginVertical: 20 },
  ...
  loginButton: { borderWidth: 1, borderColor: '#B7E4C7', paddingVertical: 5, paddingHorizontal: 30, borderRadius: 20, alignItems: 'center' },
  loginButtonText: { color: '#B7E4C7', fontWeight: 'bold' },
